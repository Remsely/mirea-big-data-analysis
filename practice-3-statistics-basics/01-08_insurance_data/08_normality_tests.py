...
for column in ['bmi', 'charges']:
    ...
    print("Интерпретация Q-Q plot: Если точки лежат примерно на красной диагональной линии, распределение близко к нормальному. Сильные "
          "отклонения от линии указывают на отличие от нормальности.")
